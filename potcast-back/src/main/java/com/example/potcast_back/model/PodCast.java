...
public class PodCast implements Serializable {
    ...
    public PodCast(String id, String temaGeneral, String temaDia, String categoria, String fecha, String audioUrl,
            Locutor locutorPrincipal, List<Locutor> invitados) {
        this.id = id;
